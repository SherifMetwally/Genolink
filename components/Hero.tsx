    ...
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-lab-blue">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center">
          ...
          >
            Precision Oncology & Onco-Hematology Diagnostics Across Egypt and North Africa..
          </motion.h1>
          ...
          >
            <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-8">
              Genolink is a leading Egypt-based precision diagnostics company specializing in Oncology and Onco-Hematology genomics. We partner with world-class accredited laboratories to deliver advanced cancer testing solutions across Egypt and North Africa..
            </p>
